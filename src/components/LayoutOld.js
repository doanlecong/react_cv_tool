...
import { Seperate, LevelTitle } from "./HelperComponent";
import Skill from "./skill_info";
import FacebookIcon from "../images/facebook.svg";
import "./LayoutOld.scss"
const SkillInfo = [
  { name: "Python", point: 4, order: 3 },
  { name: "ReactJs and related", point: 6, order: 10 },
  { name: "VueJs", point: 4, order: 4 },
  { name: "PHP", point: 6, order: 8 },
  { name: "SQL/NoSQL", point: 6, order: 5 }, // MySql/PostgreSql
  { name: "NodeJs/Express", point: 6, order: 9 },
  { name: "Ruby On Rails", point: 3, order: 3 },
  { name: "GraphQL", point: 3, order: 3 },
  { name: "C++", point: 3, order: 3 },
  { name: "Java", point: 3, order: 3 },
];
...
const DevOpsManagement = [
  ...
  { name: "CI/CD", point: 3 },
  { name: "AWS", point: 5 },
  { name: "RabbitMQ", point: 3 },
  { name: "Scrum/Agile", point: 4 },
  { name: "ElasticSearch", point: 4 },
];

const LayoutOld = () => {
  return (
    <div className="App" id="app_old">
      <div id="brief_personal_info">
        ...
        <h2 className="my_name">Le COng DOan {/*(<small>Ronalsi</small>)*/}</h2>
          ...
          <div className="info_div">
            <ul className="info_list">
              <li className="date_of_birth">
                Year Of Birth : <b>1994</b>
              </li>
              {/* <li className="id_card_num">
                ID Card Number : <b>017293468</b>
              </li> */}
              <li className="education">
                Education : BS in Computer Science And Engineering , Ho Chi Minh
        ...
        <div className="brief_introduction">
          <p style={{ marginTop: "0", marginBottom: "5px" }}>
            ...
            Computer Science and Engineering. Have a solid knowledge of data
            structures and algorithms. And I also have more than 5 years of
        ...
        <div className="devops_management_skills">
          ...
          <p style={{ margin: 0, marginTop: "5px" }}>
            Have a professional proficiency using Git, Jira, Redmine
          </p>
        </div>
      ...
      <div id="history_project">
        ...
        <div className="working_experience">
          <div className="time_line_item">
            <div className="working_time">08/2018 - 10/2021</div>
            ...
            <div className="description">
              ...
              <b> full stack developer</b>, used to be a member of a project
              under DAITO Japan. <br />
              Starting in 2021, I was transferred to DAITO VN Co.Ltd, working as
              a <b>team leader</b> and supporting the new members of the
              company. I am responsible for developing four projects at the same
              time. Our projects are related to Japan e-commerce based on a
              cloud computing platform with big data. At this company, we used
              Nodejs for streaming and realtime services, PHP(Laravel) to easily
              control our bussinesses. For storing data: we used Mysql, MongoDb,
              PostgreSql, etc. All those things are hosted on AWS cloud,S3, RDS
              and using microservice architecture powered by RabbitMQ,
              ElasticSearch to smooth the path way.
            </div>
          </div>
          <div className="time_line_item">
            <div className="working_time">10/2017 – 06/2018</div>
            <div className="company_name">DEVELOPER AT HDWEBSOFT CO.LTD</div>
            <div className="description">
              ...
              key developer of that’s team. We've focus on building a platform
              including Mobile App(Ionic), Website(PHP Yii 2). The system of
              population management and operation control of an apartment
              complex belonging to a Malaysian corporation.
            </div>
          </div>
          <div className="time_line_item">
        ...
        <div className="education_and_award">
          ...
          <div className="item">
            <div className="title">
              ENGLISH CERTIFICATE: TOEIC 700 (FROM 2017)
            </div>
            <div className="description">
        ...
        <div className="working-target-desire">
          ...
          <div className="description">
            <p>
              ...
              2. I want to develop myself in the direction of technical
              expertise
            </p>
          </div>
        </div>
